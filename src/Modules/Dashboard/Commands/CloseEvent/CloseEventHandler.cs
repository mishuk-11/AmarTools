...
internal sealed class CloseEventHandler : IRequestHandler<CloseEventCommand, Result>
{
    ...
    public async Task<Result> Handle(CloseEventCommand command, CancellationToken ct)
    {
